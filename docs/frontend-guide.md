...
- For things like keys that have string values or even numbers etc, enums, query keys, url query keys etc, always create a general constant exported from shared

- All features should be gated and should have feature flags inside the shared.constsnts.feature flags such that entire feature entrypoint can be turned off easily.
